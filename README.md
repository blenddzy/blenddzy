...
Técnico en Ciencia de Datos con experiencia en análisis de negocios, automatización de procesos y desarrollo de dashboards interactivos. Me especializo en transformar datos en decisiones estratégicas, optimizar flujos administrativos y construir soluciones analíticas end-to-end.

Actualmente trabajo como **Analista de Negocios en SUMIAGRO CBA S.A.**, donde lideré la transformación digital del área administrativa: automaticé la carga de facturas con IA + low-code, reduje un 50% el tiempo de procesamiento y desarrollé tableros de análisis de mercado con Power BI + SQL + Webscraping.
...
| **Bases de datos** | SQL (MySQL, consultas y modelado) |
| **Lenguajes** | Python, VBA, scripting .bat |
| **Automatización** | Macros Excel, Power Query, scripts |
| **Web & datos** | Webscraping (BeautifulSoup, requests) |
| **Dev** | HTML, CSS, JavaScript, Node.js, MongoDB |
...
- Scraping automatizado de múltiples proveedores
- Pipeline de limpieza y normalización de datos
- Dashboard con alertas de variación de precios
...
- KPIs de recaudación por tipo de juego (Quini 6, Lotería de Córdoba)
...
- Logs de auditoría y control de errores
...
- Visualizaciones de distribución, tendencias y correlaciones
...
- Schedulable con tareas programadas de Windows
...
- 🎓 **Técnico en Ciencia de Datos** — Instituto Técnico Superior Teclab (2022–2025)
- 📜 **Diplomatura en Ciencia de Datos** — Mundos E (2021–2022)
- 📊 **Delivery de Soluciones con Power BI** — Intertron Education (2023)
